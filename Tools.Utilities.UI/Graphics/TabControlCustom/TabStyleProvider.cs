...
namespace Tools.Utilities.UI.TabControlCustom
{
	...
	public abstract class TabStyleProvider : Component
	{
		...
		protected TabStyleProvider(TabControlCustom tabControl){
		...
		public static TabStyleProvider CreateProvider(TabControlCustom tabControl){
		...
		protected TabControlCustom _TabControl;
		...
		public void PaintTab(int index, System.Drawing.Graphics graphics){
		...
		protected virtual void DrawTabCloser(int index, System.Drawing.Graphics graphics){
			if (this._ShowTabCloser){
