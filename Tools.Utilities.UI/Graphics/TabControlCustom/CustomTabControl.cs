...
namespace Tools.Utilities.UI.TabControlCustom
{
	...
	public class TabControlCustom : System.Windows.Forms.TabControl
	{
		...
		public TabControlCustom(){
			...
			this._BackBufferGraphics = System.Drawing.Graphics.FromImage(this._BackBuffer);
			this._TabBuffer = new Bitmap(this.Width, this.Height);
			this._TabBufferGraphics = System.Drawing.Graphics.FromImage(this._TabBuffer);
		...
		private System.Drawing.Graphics _BackBufferGraphics;
		private Bitmap _TabBuffer;
		private System.Drawing.Graphics _TabBufferGraphics;
...
//		}
		...
		private void CustomPaint(System.Drawing.Graphics screenGraphics){
			...
			if (this.Width > 0 && this.Height > 0){
				if (this._BackImage == null){
                    ...
                    System.Drawing.Graphics backGraphics = System.Drawing.Graphics.FromImage(this._BackImage);
		...
		protected void PaintTransparentBackground(System.Drawing.Graphics graphics, Rectangle clipRect)
		{
		...
		private void DrawTabPage(int index, System.Drawing.Graphics graphics)
		{
			graphics.SmoothingMode = SmoothingMode.HighSpeed;
		...
		private void DrawTabBorder(GraphicsPath path, int index, System.Drawing.Graphics graphics)
		{
		...
		private void DrawTabText(int index, System.Drawing.Graphics graphics)
		{
			graphics.SmoothingMode = SmoothingMode.HighQuality;
		...
		private void DrawTabImage(int index, System.Drawing.Graphics graphics){
			Image tabImage = null;
